function lookupDTC() {
    var dtcCode = document.getElementById('dtcInput').value;
    var description = getDescription(dtcCode);

    if (description) {
        document.getElementById('descriptionOutput').innerHTML = '<strong>Description:</strong> ' + description;
    } else {
        document.getElementById('descriptionOutput').innerHTML = '<strong>Description:</strong> DTC code not found.';
    }
}

function getDescription(dtcCode) {
    var dtcDescriptions = {
        ...
        'P0485': 'Cooling Fan Power/Ground Circuit Malfunction','P0500': 'Vehicle Speed Sensor Malfunction',
        ...
        'P076': 'Shift Solenoid C Performance or Stuck Off',
